...
# pixelRatio = 16
# Scene = screen(pixelRatio*8, pixelRatio*8, backgroundColor)
...
# blocks = toolsBig.getPixelImage(0) 
# spritesBigTop = []
...
#         addToScreen(borderingBackground, square(pixelRatio, pixelRatio, newBlack), 1, 1)
#         addBorderToColor(borderingBackground, yellow, newBlack, white)
#         borderCreation = scanArea(borderingBackground, (1, 1), pixelRatio, pixelRatio)
#         addToScreenWithoutColor(Scene, borderCreation, newBlack, c, r)
#         erase = True
#         Stored = [square(pixelRatio, pixelRatio, backgroundColor), c, r]
#         printScreen(Scene)
#         # printCurrentPos(r, c, Pallete[rc%mod], borderColor, erase)
